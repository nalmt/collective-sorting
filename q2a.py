...
class Agent:
    ...
    def f_a(self):
        return (self.get_number_of_around('A') + self.get_number_of_around('B') * ERREUR)/self.number_of_boxes()
    
    def f_b(self):
        return (self.get_number_of_around('B') + self.get_number_of_around('A') * ERREUR)/self.number_of_boxes()
